...
function MockZigTradesWorkflow() {
  return (
    <Card className="glass">
      <CardHeader>
        <CardTitle>ZigTrades Workflow</CardTitle>
      </CardHeader>
      <CardContent>
        <p className="text-muted-foreground">Workflow component placeholder</p>
      </CardContent>
    </Card>
  );
}

function MockPremiumFeatureTeasers() {
  return (
    <Card className="glass">
      <CardHeader>
      ...
      <CardContent>
        <p className="text-muted-foreground">Premium features placeholder</p>
      </CardContent>
    </Card>
  );
}

function MockOpenPositions() {
  return (

          ...
          <div className="mb-8 text-center">
            <div className="inline-block">
              <Logo 
                ...
                href="/"
                showText={false}
                className="justify-center bg-gray-900 rounded-full p-3"
              />
              <div className="mt-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="firstName" className="text-gray-700 dark:text-gray-200 font-medium">
                      First Name
                    </Label>
                    <Input
                      id="firstName"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="lastName" className="text-gray-700 dark:text-gray-200 font-medium">
                      Last Name
                    </Label>
                    <Input
                      id="lastName"

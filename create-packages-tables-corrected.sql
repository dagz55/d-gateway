-- =====================================================
-- Create Packages Tables for Zignal Platform - CORRECTED VERSION
-- Created: 2025-01-28
...
-- Only admins can insert/update/delete packages (CORRECTED to use profiles table)
...
-- Admins can view all subscriptions (CORRECTED to use profiles table)
...
-- Admins can manage all subscriptions (CORRECTED to use profiles table)

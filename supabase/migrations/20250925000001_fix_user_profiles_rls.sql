...
-- Migration: 20250925000001_fix_user_profiles_rls.sql
-- =====================================================
...
-- Function to update user profile by Clerk ID
...
-- Function to create or update user profile by Clerk ID
...
GRANT EXECUTE ON FUNCTION public.update_user_profile_by_clerk_id(TEXT, JSONB) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.update_user_profile_by_clerk_id(TEXT, JSONB) TO service_role;

-- =====================================================
-- Corrected SQL to create packages tables
-- Fixed for bigint vs UUID compatibility issues
-- =====================================================
...
-- Use a more flexible admin check that works with both profiles and user_profiles tables
...
AND table_name IN ('packages', 'user_packages')
ORDER BY table_name, ordinal_position;

-- Check sample data
SELECT COUNT(*) as package_count FROM public.packages;
SELECT name, price, duration_days FROM public.packages WHERE active = true;

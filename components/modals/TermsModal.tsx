      ...
      <DialogContent className="max-w-4xl max-h-[80vh]">
        ...
        <ScrollArea className="h-[60vh] pr-6">
          <div className="space-y-6 text-sm">
            ...
            <section>
              <h3 className="font-semibold text-base mb-3">3. Risk Disclosure</h3>
            ...
            <section>
              <h3 className="font-semibold text-base mb-3">5. Intellectual Property</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h3 className="font-semibold text-base mb-3">6. Prohibited Uses</h3>
            ...
            <section>
              <h3 className="font-semibold text-base mb-3">7. Disclaimer of Warranties</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h3 className="font-semibold text-base mb-3">8. Limitation of Liability</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h3 className="font-semibold text-base mb-3">9. Termination</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h3 className="font-semibold text-base mb-3">10. Changes to Terms</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h3 className="font-semibold text-base mb-3">11. Contact Information</h3>
              <p className="text-muted-foreground leading-relaxed">
